...
public class AddToDoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra(ToDoItem.PRIORITY)!= null){
            Priority pri = Priority.valueOf(intent.getStringExtra(ToDoItem.PRIORITY));
            if (pri == Priority.HIGH) mPriorityRadioGroup.check(R.id.highPriority);
            if (pri == Priority.MED) mPriorityRadioGroup.check(R.id.medPriority);
            if (pri == Priority.LOW) mPriorityRadioGroup.check(R.id.lowPriority);
        }

		mStatusRadioGroup = (RadioGroup) findViewById(R.id.statusGroup);
        if (intent.getStringExtra(ToDoItem.STATUS)!= null) {
            Status sta = Status.valueOf(intent.getStringExtra(ToDoItem.STATUS));
            if (sta == Status.NOTDONE) mStatusRadioGroup.check(R.id.statusNotDone);
            if (sta == Status.DONE) mStatusRadioGroup.check(R.id.statusDone);
        }
	...
	private void setDefaultDateTime(Date date) {
